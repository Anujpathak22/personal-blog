        ...
        <div className="flex flex-col items-center my-6 xl:flex-row gap-x-12 xl:mb-12">
          <div className="pt-6">
            ...
            <h2 className="text-lg prose text-gray-600 dark:text-gray-400">
              {`Welcome 👋 to my Personal blogging website, where I share my knowledge and insights about the latest trends and developments in the world of technology   ${siteMetadata.description} checkout some of my   `}
